...
4. Все датчики и устройства должны быть описаны в таблице подключения, как в нашем примере для Raspberry Pi и ESP32.
...
**Таблица подключения для программиста:**

| №  | GPIO        | Название           | Тип           | Описание                               | Дополнительно               | I2C Address |
|----|------------|------------------|---------------|----------------------------------------|-----------------------------|-------------|
...
| 14 | 4          | WATER_TEMP_1     | INPUT         | Температура воды (DS18B20, 1-Wire)     | Подтяжка 4.7kΩ к 3.3V, AMS1117 | -       |
| 15 | 18         | ULTRASONIC_TRIG_1| OUTPUT        | УЗ датчик уровня (Trig)                 | 3.3V, 1 GPIO               | -           |
| 16 | 25         | ULTRASONIC_ECHO_1| INPUT         | УЗ датчик уровня (Echo)                 | Делитель 5V→3.3V            | -           |
...
| №  | GPIO | Название      | Тип          | Описание                    | Дополнительно           | I2C Address |
|----|------|---------------|--------------|-----------------------------|------------------------|-------------|
| 1  | 21   | CJMCU-811     | I2C          | CO₂ / VOC датчик            | 3.3V, GND, SDA/SCL     | 0x5A        |
